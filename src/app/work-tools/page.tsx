...
const projects: Tool[] = [
  {
    ...
    description:
      'Convert your employees time into monthly hour count for UrVenue time sheet.',
              ...
              >
                {project.image && (
                  <a href={project.link} {...linkProps}>
                    {/* Consider Next/Image later to silence the no-img-element warning */}
                    <img
                      src={project.image}
                      alt={project.title}
